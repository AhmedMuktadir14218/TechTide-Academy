          ...
          <div className="grid grid-rows-1 gap-4">
            ...
            <div className="card w-106 bg-base-100 shadow-xl hover:bg-primary">
              <div className="card-body">
                <h2 className="card-title text-bold font-bold">Online Courses</h2>
            ...
            <div className="card w-106 bg-base-100 shadow-xl hover:bg-primary">
              <div className="card-body">
                <h2 className="card-title text-bold">Earn with Expert</h2>
                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
            ...
            <div className="card w-106 bg-base-100 shadow-xl hover:bg-primary">
              <div className="card-body">
                <h2 className="card-title text-bold">Earn A Certificates</h2>
                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                <div className="card-actions justify-end">
                  {/* <button className="btn btn-primary">Buy Now</button> */}
                </div>
