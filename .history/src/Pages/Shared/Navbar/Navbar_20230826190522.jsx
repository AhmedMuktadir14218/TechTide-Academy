...
<div className="navbar-start">
 ...
 <a className="btn btn-ghost normal-case lg:text-xl sm:te"><img className="object-contain h-6 w-8 ..." src="/src/assets/react.svg" alt="" /> <Link to="/" >TechTide Academy</Link></a>
</div>
