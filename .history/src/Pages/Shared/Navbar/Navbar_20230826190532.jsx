...
<div className="navbar-start">
 ...
 <a className="btn btn-ghost normal-case lg:text-xl sm:text-normal"><img className="object-contain h-6 w-8 ..." src="/src/assets/react.svg" alt="" /> <Link to="/" >TechTide Academy</Link></a>
</div>
...
<div className="navbar-end">
 <a className="btn btn-primary">Enroll</a>
</div>
</div>
     </>
    );
