...
<div className="navbar-start">
 ...
 <a className="btn btn-ghost hover:bg-blue-600 normal-case lg:text-xl sm:text-md"><img className="object-contain h-6 w-8 ..." src="/src/assets/react.svg" alt="" /> <Link to="/" >TechTide Academy</Link></a>
</div>
