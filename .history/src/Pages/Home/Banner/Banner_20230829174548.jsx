  ...
  >
    <div className="max-w-xl text-start ltr:sm:text-left rtl:sm:text-right">
      ...
      <div className="mt-8 flex flex-wrap gap-4 text-center">
        ...
        <a
          href="#"
          className="block w-full rounded bg-white px-12 py-3 text-sm font-medium text-rose-600 shadow hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500 sm:w-auto"
        >
          Learn More
        </a>
      </div>
