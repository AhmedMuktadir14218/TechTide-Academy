...
const fetchurl = `https://www.googleapis.com/youtube/v3/playlistItems?key=${API}&playlistId=PLf3qsnGljClRUPUS1HpAItd_p2X0HKpEn&part=snippet,id&order=date&maxResults=20`;
